...
async function getPrInfoForSpeculativeBranch(settings, gitRepoRootPath) {
    ...
    if (baseCommit === headCommit) {
        throw new Error(`Speculative branch selection failed. baseCommit can't be equal to headCommit (${baseCommit}). Please create Pull Request to skip this problem.`);
    }
